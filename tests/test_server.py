...
class TestCoreTypes:
    ...
    def test_window_info_dataclass(self):
        ...
        from recorder.core.types import WindowBounds, WindowInfo

        bounds = WindowBounds(x=0, y=0, width=100, height=100)
        info = WindowInfo(
            title="Test Window", window_id="123", pid=456, bounds=bounds, app_name="TestApp"
        )
    ...
    def test_recording_result_dataclass(self):
        ...
        result = RecordingResult(
            success=True, message="Recording started", file_path=Path("/tmp/test.mp4")
        )
...
class TestCoreConfig:
    ...
    def test_get_recordings_dir(self):
        ...
        from recorder.core.config import (
...
class TestBackends:
    ...
    def test_get_backend_returns_host_on_non_container(self):
        ...
        from recorder.backends import HostBackend, get_backend
        from recorder.core.config import is_container_environment
